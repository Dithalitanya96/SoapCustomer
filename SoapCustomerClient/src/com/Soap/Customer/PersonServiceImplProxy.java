...
public class PersonServiceImplProxy implements com.Soap.Customer.PersonServiceImpl {
  private String _endpoint = null;
  private com.Soap.Customer.PersonServiceImpl personServiceImpl = null;
  ...
  private void _initPersonServiceImplProxy() {
    try {
      personServiceImpl = (new com.Soap.Customer.PersonServiceImplServiceLocator()).getPersonServiceImpl();
  ...
  public com.Soap.Customer.PersonServiceImpl getPersonServiceImpl() {
    if (personServiceImpl == null)
      _initPersonServiceImplProxy();
