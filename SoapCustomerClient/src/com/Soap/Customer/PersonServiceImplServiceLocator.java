...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.Soap.Customer.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8080/SoapCustomer/services/PersonServiceImpl";
    ...
    public com.Soap.Customer.PersonServiceImpl getPersonServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.Soap.Customer.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.Soap.Customer.PersonServiceImplSoapBindingStub _stub = new com.Soap.Customer.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.Soap.Customer.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.Soap.Customer.PersonServiceImplSoapBindingStub _stub = new com.Soap.Customer.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Customer.Soap.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Customer.Soap.com", "PersonServiceImpl"));
        }
